...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../pages/project'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const router = async ()=>{
    ...
    if (routes[hash] !== undefined) content.append(await routes[hash]());
        ...
        content.append(await Object(function webpackMissingModule() { var e = new Error("Cannot find module '../pages/project'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(project));
    }
...
//# sourceMappingURL=main.1078ea90359ca786ab00.hot-update.js.map